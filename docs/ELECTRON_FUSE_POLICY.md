...
> 当前实现：`0.1.0-alpha.22`。本文件描述源码配置、打包后强制写入与回读、ASAR 资源/production package 身份及受限应用协议合同；真实未签名 Windows alpha 二进制证据以 `TEST_REPORT.md` 为准。
