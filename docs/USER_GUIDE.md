...
标准页还把“审阅状态”和“来源核验”分开显示。`规则已启用` 只表示当前检查会使用对应规则，不等于来源已经核验。当前内置 13 项中有 9 项规则已启用、4 项待复核；来源已核验 0、待核验 12、来源未取得 1，因此页面会明确显示“标准治理门禁未完成”，不能据此宣称完整覆盖 GB/T、APA、Chicago 或 EPUB 标准。
