...
当前开发源码为 `0.1.0-alpha.56`，最新已打包 Windows x64 NSIS/ZIP 仍为 `0.1.0-alpha.54`；制品未签名，不是可售卖正式版。alpha.56 在 Web 组合/迁移门禁上增加平台能力准入；默认账号与权益配置仍为空，仓库没有生产私钥，普通启动和构建不会触发账号/权益联网或下载。
