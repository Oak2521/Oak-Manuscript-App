...
当前开发版本为 `0.1.0-alpha.2`。已进入商业克隆的 P0 离线发布资源可信链收口；具体事实仍须以代码、`npm test` 和 `docs/DEVELOPMENT_STATUS.md` 交叉核对。Windows 正式安装器、macOS 可安装版本、Web、统一账号、订阅、结果同步和标准自动升级均属于 v2.0 方案后续工作，未经真实验收不得写成已完成。
